...
$(document).ready(function(){
	...
	function open1(){
       window.open('showresult.jsp','newwindow','width=980,height=680,top=100,left=260,toolbar=no,menubar=no,titlebar=no,location=no,resizeable=no');
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="5%">
    <tr background="">
        <td height="5%" background="pages/images/systemLogo2.JPG">
            <img src="pages/images/systemLogoNew.gif" height="60" />
        </td>
    </tr>
</table>
                ...
                <tr>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                                <td width="2px"></td>
                                <td style="background-image:url(pages/images/bg.jpg); line-height:24px; color:#fff; font-weight:bold; cursor:pointer;"onclick="show(32);"><img src="pages/images/folder.gif" width="20" height="20" style="float:left; margin-left:2px; margin-right:5px;"/>基本信息录入</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                                        <tr>
                                            ...
                                            <td width="80%">
                                                <div id="list32">
                                                    <a href="javascript:detailShowSrc('userList.action')" >用户管理</a>
                                                    <a href="javascript:detailShowSrc('fruitList.action')" >地区管理</a>
                                                    <a href="javascript:detailShowSrc('rechargePassword.action')" >充值管理</a>
                                                    <a href="javascript:detailShowSrc('deviceList.action')" >设备管理</a>
                                                    <a href="javascript:detailShowSrc('demo.action')" >模拟调试</a>
                                                    <%--<a href="javascript:detailShowSrc('toModifyPassword.action')" >充值密码设置</a>--%>
                                                    <%--<a href="javascript:detailShowSrc('latticeStatusList.action')" >控制器管理</a>--%>
                                                    <a href="javascript:detailShowSrc('iCPortList.action')" >玩具管理</a>
                                                    <%--<a href="javascript:detailShowSrc('srmm.jsp')" >最低剩余金额</a>--%>
                                                    <%--<a href="javascript:detailShowSrc('toEditURL.action')" >url地址配置</a>--%>
                                                    <%--<a href="javascript:detailShowSrc('feedBackList.action')" >反馈查询</a>--%>
                                                     <a href="javascript:detailShowSrc('orderList.action')" >订单查询</a>
                                                      <a href="javascript:detailShowSrc('socketLogList.action')" >通信日志</a>
                                                    <s:if test="username=='secadmin'">
                                                      <a href="javascript:detailShowSrc('rechargeUserList.action')" >账户管理</a>
                                                    </s:if>
                                                </div>
                                            </td>
                                        </tr>
...
<div id="p_mydiv" class="pmydiv">
	<table align="center">
	    <tr><td>&nbsp;</td></tr>
		<tr><td><input type="hidden" id="p_mydiv_id"></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr align="center">
			<td><input type="button" class="FixButtonStyle" value="确定" onclick="Javascript:deleteAssess('deleteAssess.action?id=')" /></td>
			<td><input type="button" class="FixButtonStyle" value="取消" onclick="Javascript:cancel()" /></td>
		</tr>
	</table>
</div>
<div id="p_department" class="pmydiv">
	<table align="center">
	    <tr><td>&nbsp;</td></tr>
		<tr><td><input type="hidden" id="p_department_id"></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr align="center">
			<td><input type="button" class="FixButtonStyle" value="确定" onclick="Javascript:deleteDepartment('deleteDepartment.action?id=')" /></td>
			<td><input type="button" class="FixButtonStyle" value="取消" onclick="Javascript:cancel()" /></td>
		</tr>
	</table>
</div>
