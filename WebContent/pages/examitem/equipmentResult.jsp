...
function testdeleteLDAPUsers(){
	...
	function searchUser(){
		document.forms[0].action = "equipmentResultList.action";
		document.forms[0].submit();	
	}
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="5" class="NormalText">
			...
			<table class="NormalText">			
				<tr>
                    ...
                    <s:select id="stateSearch" name="stateSearch" list="stateMap"  cssStyle="width:180px;" value="stateSearch"/></td>
                     </td> 
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <THEAD>
                    <tr><TH vAlign=center align=middle noWrap width="4%"><s:checkbox name="mainUser"
                        ...
                        <TH vAlign=center align=middle noWrap width="15%"><s:text name="姓名" /></TH>
                        <TH vAlign=center align=middle noWrap width="20%"><s:text name="跑步距离" /></TH>
                        <TH vAlign=center align=middle noWrap width="20%"><s:text name="成绩" /></TH>
                        <TH vAlign=center align=middle noWrap width="20%"><s:text name="状态" /></TH>
                        <TH vAlign=center align=middle noWrap width="20%"><s:text name="测试日期" /></TH>
