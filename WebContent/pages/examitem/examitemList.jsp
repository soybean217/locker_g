	...
	<table width="100%" border="0" cellpadding="2" cellspacing="5" class="NormalText">
		<tr>
			...
			<td><input type="button" id="add" class="FixButtonStyle"
				...
				onclick="window.location.href='toAddExamItem.action'" />&nbsp; 
				</td>
		</tr>
		<tr>
			<td width="1%"></td>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <THEAD>
                    <tr><TH vAlign=center align=middle noWrap width="4%"><s:checkbox name="mainUser"
                        ...
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="项目" /></TH>
                        <TH vAlign=center align=middle noWrap width="25%"><s:text name="录入日期" /></TH>
                        <TH vAlign=center align=middle noWrap width="25%"><s:text name="说明" /></TH>
				...
				<s:iterator value="list" id="score" status="index">
					<tr class="<s:if test='#index.Even'>DarkEntryTr</s:if><s:else>LightEntryTr</s:else>">
						...
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>">${myfn:getSelectValue('rangeitem',name)}</td>
						...
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="remark"></s:property></td>
				</tr>
				</s:iterator>
