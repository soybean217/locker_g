...
function testdeleteLDAPUsers(){
	...
	function searchUser(){
		document.forms[0].action = "equipmentResultListkh.action";
		document.forms[0].submit();	
	}
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <THEAD>
                    <tr><TH vAlign=center align=middle noWrap width="4%"><s:checkbox name="mainUser"
                        ...
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="一级标题" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="二级标题" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="部门" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="姓名" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="跑步距离" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="成绩" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="测试结果" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="测试日期" /></TH>
				...
				<s:iterator value="resultlist" id="list"  status="index">
					<tr class="<s:if test='#index.Even'>DarkEntryTr</s:if><s:else>LightEntryTr</s:else>">
						...
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="#list[6]" /></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="#list[7]" /></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="#list[8]" /></td>
						...
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="#list[3]" /></td>
				</tr>
				</s:iterator>
