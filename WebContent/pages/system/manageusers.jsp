			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <THEAD>
                    ...
                    <s:checkbox name="mainUser"
                        ...
                        <TH vAlign=center align=middle noWrap width="20%"><s:text name="openid"/></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="姓名"/></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="性别" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="电话" /></TH>
                        <TH vAlign=center align=middle noWrap width="15%"><s:text name="微信号" /></TH>
                        <TH vAlign=center align=middle noWrap width="15%"><s:text name="身份证号" /></TH>
                          <TH vAlign=center align=middle noWrap width="10%"><s:text name="账户余额(元)" /></TH>
                          <TH vAlign=center align=middle noWrap width="10%"><s:text name="操作时间" /></TH> 
				...
				<s:iterator value="userList" status="index">
					<tr class="<s:if test='#index.Even'>DarkEntryTr</s:if><s:else>LightEntryTr</s:else>">
                        ...
                        <td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="openid"></s:property></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>">
                            <div><img src='<s:property value="avatar"></s:property>' class="avatar" /></div>
                            <a href="toeditUser.action?id=<s:property value="id"></s:property>"><s:property value="name"></s:property></a>
                        </td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="sex"></s:property></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="telephone"></s:property></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="wx"></s:property></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="sfz"></s:property></td>
