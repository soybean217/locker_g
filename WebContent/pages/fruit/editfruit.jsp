...
<script type="text/javascript">
	...
	function init(){
		var url = document.getElementById("fruit.imageurl").value;
		document.getElementById("fruitimage").src=url;
	}
</script>
<script language="javascript" src="/javascript/JumpMenu.js"></script>
<body onload="init();">
<s:form name="input" action="editFruit.action" method="post"
	...
	<input type="hidden" id="fruit.imageurl" name="fruit.imageurl" value="<s:property value="fruit.imageurl"/>"/>
		<table width="100%" align="center" border="1" cellspacing="0"
			...
			<tr align="left">
					<td width="2%">&nbsp;</td>
					<td>编号:</td>
					<td align="left"><s:textfield readonly="true" name="fruit.num"
