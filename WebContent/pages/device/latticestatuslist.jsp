...
function onload(){
	...
	function searchUser(){
		document.forms[0].action = "latticeStatusList.action";
		document.forms[0].submit();	
	}
...
<s:form name="input" enctype="multipart/form-data" method="post">
    ...
    <table>
			...
			<legend class="LegendTitle"><s:text name="格子搜索" /></legend>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <THEAD>
                    <tr><TH vAlign=center align=middle noWrap width="4%"><s:checkbox name="mainUser"
                        ...
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="锁ID"/></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="状态" /></TH>
                        <TH vAlign=center align=middle noWrap width="15%"><s:text name="备注" /></TH>
                        <TH vAlign=center align=middle noWrap width="10%"><s:text name="操作时间" /></TH>
           
                    </tr>
                </THEAD>
                <!--Resource View Table Entry -->
				<s:iterator value="latticeStatus" status="index">
					<tr class="<s:if test='#index.Even'>DarkEntryTr</s:if><s:else>LightEntryTr</s:else>">
						...
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="lattice"></s:property></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="type"></s:property></td>
						<td align="center" class="<s:if test='#index.Even'>DarkLogLine</s:if><s:else>LightLogLine</s:else>"><s:property value="comment"></s:property></td>
	...
	<div align="right" style="width:100%;">
      <div align="right" style="padding-right:10px;"
                class="NormalText">
                <s:if test="#request.latticeStatus != null && #request.latticeStatus.size > 0">
