...
<body>
<s:form name="input" action="validatePasword.action" method="post"
	enctype="multipart/form-data">
	 <input type="hidden" name="userid" id="userid" size="15" value="<s:property value='#request.userid'/>"/>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="10"
		...
		<tr>
			...
			<fieldset class="FieldsetBorder"><legend
				class="LegendTitle">输入密码信息</legend>
			<table width="100%" align="center" border="1" cellspacing="0"
				...
				<tr align="left">
					<td width="2%">&nbsp;</td>
					<td>用户名:</td>
					<td align="left"><s:textfield id="name" name="name"
			...
			<tr align="left">
					<td width="2%">&nbsp;</td>
					<td>密码:</td>
					<td align="left"><s:password id="password" name="password"
						size="30" cssClass="Input" /></td>
					<td></td>
					<td align="left"></td>
				</tr>
		...
		<tr>
			...
			<table width="100%" align="center" border="1" cellspacing="0"
				...
				<tr>
					<td width="3%"></td>
					<td><input type="button" name="ok" value="提交"
