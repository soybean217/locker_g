...
<body >
<s:form name="input" action="updateProject.action"  method="post" enctype="multipart/form-data">
	<table width="100%" border="0" cellpadding="0" cellspacing="10" class="NormalText">
	  <input type="hidden" name="project.id" id="project.id" value="<s:property value="project.id"/>"/>
        <tr>
		...
		<tr>
			...
			<table width="100%" align="center" border="1" cellspacing="0"
               ...
               <tr align="left">
					<td align="left"></td>
                    <td>二级科目名:</td>
                    <td align="left" colspan="3"><s:select id="select2" name="project.secondproject" list="secondMap" cssStyle="width:180px;" value="project.secondproject"/></td>
			    </tr>
			        <tr align="left">
					<td align="left"></td>
                    <td>成绩类型:</td>
                    <td align="left" colspan="3"><s:select id="select2" name="project.scoretype" list="scoretypeMap" cssStyle="width:180px;" value="project.scoretype"/></td>
			    </tr>
