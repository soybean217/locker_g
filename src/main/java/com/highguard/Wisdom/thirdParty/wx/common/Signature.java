...
public class Signature {
	 ...
	 * @return
	 */
	public static boolean validateSign(Map<String, Object> parameters){
		String requestSign = parameters.remove("sign").toString();
     ...
     */
    public static String getSign(Object o) throws IllegalAccessException, UnsupportedEncodingException {
        ...
        result += "key=" + ConfigureXian63.getKey();
...
//        Util.log("Sign Result:" + result);
    ...
    public static void main(String[] args) {
    	String s="appid=wx58b66e926b87f442&noncestr=v5xuzm5grxmyjfniv2sl39rf4uri4853&package=Sign=WXPay&partnerid=1321294401&prepayid=wx2016032021155471d20b21020478346138&timestamp=1458479754&key=sihaiweijia0123456789sihaiweijia";
    	String ss = MD5.MD5Encode(s);
    }
    /**
